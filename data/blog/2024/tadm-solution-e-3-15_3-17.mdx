---
title: The Algorithm Design Manual (3rd) Exercise Solution 'E3-15 and E-3-17'
date: '2024-08-17'
tags: ['algorithm', 'The Algorithm Design Manual']
draft: false
summary: My solution for exercise 3-15 and 3-17 in The Algorithm Design Manual
layout: PostSimple
---
...
```cpp showLineNumbers {46-67, 85-125}
#include <cassert>
#include <concepts>
#include <functional>
