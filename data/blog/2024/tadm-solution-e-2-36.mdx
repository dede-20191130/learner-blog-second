---
title: The Algorithm Design Manual (3rd) Exercise Solution 'E2-36'
date: '2024-06-07'
tags: ['algorithm', 'The Algorithm Design Manual']
draft: false
summary: My solution for exercise 2-36 in The Algorithm Design Manual
layout: PostSimple
---
...
$\lg{n!}$ is bound by two simple multiple of $n\lg{n}$ and their domination limits (either $\lg{n!}$ is numerator or denominator) does not converge into 0.
