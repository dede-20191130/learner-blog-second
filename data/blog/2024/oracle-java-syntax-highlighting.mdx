...
3. Create new entry and set the name and url(oracle website)
   ![new entry](https://res.cloudinary.com/ddxhi1rnh/image/upload/v1713428408/learner-blog-second/oracle-java-syntax-highlighting/ua8n95jp5s51mxhroj1m.png)
...
![before highlighting](https://res.cloudinary.com/ddxhi1rnh/image/upload/v1713428472/learner-blog-second/oracle-java-syntax-highlighting/zmtkehrchyogg3iwbnht.png)

### After

![after highlighting](https://res.cloudinary.com/ddxhi1rnh/image/upload/v1713428473/learner-blog-second/oracle-java-syntax-highlighting/jvjnnla5yw4iwhxiqyr5.png)
